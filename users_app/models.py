...
class CustomUser(AbstractUser, BaseModel):
    ...
    # followers = models.ForeignKey(Followers, on_delete=models.CASCADE, related_name="followers")
    # followings = models.ForeignKey(Followings, on_delete=models.CASCADE, related_name="followings")
